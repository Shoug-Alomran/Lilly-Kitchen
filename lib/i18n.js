...
const messages = {
  en: {
    ...
    actions: {
      ...
      chooseLocation: "Choose where to save this recipe.",
      noFolder: "Save without a folder",
      newFolder: "Create a new folder",
      folderName: "Folder name",
      saveSelection: "Save Here",
      createAndSave: "Create Folder and Save",
      savedLocations: "Saved in",
      removeAll: "Remove from Saved",
  ...
  ar: {
    ...
    actions: {
      ...
      chooseLocation: "اختاري مكان حفظ هذه الوصفة.",
      noFolder: "احفظيها بدون مجلد",
      newFolder: "إنشاء مجلد جديد",
      folderName: "اسم المجلد",
      saveSelection: "احفظي هنا",
      createAndSave: "أنشئي المجلد واحفظي",
      savedLocations: "محفوظة داخل",
      removeAll: "إزالة من المحفوظات",
